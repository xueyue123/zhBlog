...
class Article(models.Model):
	...
	tag = models.CharField(max_length = 32, default = "")	#文章标签，用于快速搜索文章和搜索引擎优化
	content = models.TextField()
	click = models.IntegerField(default = 0)		#文章阅读次数
	#use datetime.now() to add article will made time is server run time, not article post time.
