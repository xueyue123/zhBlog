...
def index(request):
	...
	content_dict = {'articles': article_list, 'categories': category_list, 'essays': essays_list,  'user': user, 'userprofile': userprofile}
...
def category(request):
	...
	content_dict = {'articles': article_list, 'categories': category_list, 'essays': essays_list, 'category': category}
	return render(request, 'blog/category.htm', content_dict)
...
def all_article(request):
	...
	content_dict = {'articles': article_list, 'categories': category_list, 'essays': essays_list, 'category': category}
	return render(request, 'blog/all_article.htm', content_dict)
...
def article(request):
	...
	content_dict = {'article': article, 'categories': category_list, 'essays': essays_list, 'comments': comment_list}
	return render(request, 'blog/article.htm', content_dict)
...
def all_essays(request):
	...
	category_list = Category.objects.filter(user=user)
	essays_list = Essays.objects.filter(user=user.id)[:8]
	all_essays = Essays.objects.all()
	content_dict = {'allessays': all_essays, 'categories': category_list, 'essays': essays_list}
	return render(request, 'blog/all_essays.htm', content_dict)
...
def essays(request):
	...
	category_list = Category.objects.filter(user=user)
	essays_list = Essays.objects.filter(user=user.id)[:8]
	essay = Essays.objects.get(id = request.GET.get('id'))
	content_dict = {'categories': category_list, 'essays': essays_list, 'essay': essay}
	return render(request, 'blog/essays.htm', content_dict)
...
def message(request):
	...
	category_list = Category.objects.filter(user=user)
	essays_list = Essays.objects.filter(user=user.id)[:8]
	content_dict = {'categories': category_list, 'essays': essays_list}
	return render(request, 'blog/message.htm', content_dict)
